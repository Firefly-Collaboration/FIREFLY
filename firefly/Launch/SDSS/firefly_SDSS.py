...
input_file = os.path.join(repo_root, 'Data', 'example_data', 'SDSS_ex', 'spec-0266-51602-0001.fits')
...
# Set output folder and output filename in firefly directory and write output file
