...
===================================================================================
 <> Module: firefly_estimations_3d.py
 ...
 <> Purpose:
	- The class interpolate z values from a 3D surface, starting from an irregular
      set of x, y and z points.
    - It estimates any position using input data using Inverse Squared Distance
      method (ISD) which is very stable for estimation - no divisions by 0

 <> Acknowledgements:
    - Adapted from:
      https://stackoverflow.com/questions/36031338/interpolate-z-values-in-a-3d-surface-starting-from-an-irregular-set-of-points
